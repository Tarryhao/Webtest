...
<html>
  ...
  function land()
{
	window.location.href = 'UserLand2.jsp';
}
var x;
var y;
function check()
 ...
 function changerand()
{
 ...
 //添加回车键事件
  ...
  function onlyEng()
  {
	  if(!((event.keyCode>=65&&event.keyCode<=90)||(event.keyCode>=48&&event.keyCode<=57)||(event.keyCode==9))||(event.keyCode==8)||(event.keyCode==0x6e)||(event.keyCode==46)){
